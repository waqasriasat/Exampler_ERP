...
{
  public class PR_Main_DashboardController : PositionController
  {
    private readonly AppDBContext _appDBContext;
    private readonly IStringLocalizer<PR_Main_DashboardController> _localizer;
    ...
    public PR_Main_DashboardController(AppDBContext appDBContext, IConfiguration configuration, Utils utils, IHubContext<NotificationHub> hubContext, IStringLocalizer<PR_Main_DashboardController> localizer) 
    : base(appDBContext)
    {
    ...
    public async Task<IActionResult> Index()
    {
      ...
      return View("~/Views/Purchase/Main/Dashboard/PR_Main_Dashboard.cshtml");
    }
  }
}
