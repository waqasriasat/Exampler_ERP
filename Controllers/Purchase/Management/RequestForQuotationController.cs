...
namespace Exampler_ERP.Controllers.Purchase.Management
{
  public class RequestForQuotationController : PositionController
  {
    ...
    public async Task<IActionResult> ExportToExcel()
    {
      ...
      {
        var worksheet = package.Workbook.Worksheets.Add(_localizer["RequestForQuotation"]);
        ...
        stream.Position = 0;
        string excelName = _localizer["RequestForQuotation"]+$"-{DateTime.Now.ToString("yyyyMMddHHmmssfff")}.xlsx";
