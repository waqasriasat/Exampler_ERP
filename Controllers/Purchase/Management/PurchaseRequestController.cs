...
namespace Exampler_ERP.Controllers.Purchase.Management
{
  public class PurchaseRequestController : PositionController
  {
    ...
    public async Task<IActionResult> ExportToExcel()
    {
      ...
      {
        var worksheet = package.Workbook.Worksheets.Add(_localizer["lbl_PurchaseRequest"]);
        ...
        stream.Position = 0;
        string excelName = _localizer["lbl_PurchaseRequest"]+$"-{DateTime.Now.ToString("yyyyMMddHHmmssfff")}.xlsx";
