...
private readonly IHubContext<NotificationHub> _hubContext;
    ...
    public EmployeeRequestApprovalDetailController(AppDBContext appDBContext, IConfiguration configuration, Utils utils, IHubContext<NotificationHub> hubContext)
    {
