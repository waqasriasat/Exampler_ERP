...
{
  public class ProcessApprovalDetailController : Controller
  {
...
private readonly IHubContext<NotificationHub> _hubContext;
    ...
    public ProcessApprovalDetailController(AppDBContext appDBContext, IConfiguration configuration, Utils utils, IHubContext<NotificationHub> hubContext)
    {
