...
namespace Exampler_ERP.Controllers.HR.MasterInfo
{
  ...
  public class EmployeeRequestTypeController : PositionController
  {
    ...
    public async Task<IActionResult> ExportToExcel()
    {
      ...
      {
        var worksheet = package.Workbook.Worksheets.Add(_localizer["lbl_EmployeeRequestType"]);
        worksheet.Cells["A1"].Value = _localizer["lbl_EmployeeRequestTypeID"];
        ...
        for (int i = 0; i < EmployeeRequestTypees.Count; i++)
        {
          ...
          worksheet.Cells[i + 2, 3].Value = EmployeeRequestTypees[i].ActiveYNID == 1 ? _localizer["lbl_Yes"] : _localizer["lbl_No"];
        }
        ...
        stream.Position = 0;
        string excelName = _localizer["lbl_EmployeeRequestType"]+$"-{DateTime.Now.ToString("yyyyMMddHHmmssfff")}.xlsx";
