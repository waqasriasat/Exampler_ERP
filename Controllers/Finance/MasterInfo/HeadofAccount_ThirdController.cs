...
{
  public class HeadofAccount_ThirdController : PositionController
  {
    ...
    public async Task<IActionResult> ExportToExcel()
    {
      ...
      using (var package = new ExcelPackage())
      {
        ...
        for (int i = 0; i < HeadofAccount_Thirds.Count; i++)
        {
          ...
          worksheet.Cells[i + 2, 3].Value = HeadofAccount_Thirds[i].ActiveYNID == 1 ? _localizer["lbl_Yes"] : _localizer["lbl_No"];
        }
