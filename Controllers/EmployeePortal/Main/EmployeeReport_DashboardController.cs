...
private readonly IHubContext<NotificationHub> _hubContext;
    ...
    public EmployeeHR_Report_DashboardController(AppDBContext appDBContext, IConfiguration configuration, Utils utils, IHubContext<NotificationHub> hubContext)
    {
