...
namespace Exampler_ERP.Utilities
{
  public class Utils
  {
    ...
    public async Task<List<SelectListItem>> GetEmployee()
    {
      ...
      selectList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
      return selectList;
    }
    ...
    public async Task<List<SelectListItem>> GetGender()
    {
      ...
      GenderList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetMaritalStatus()
    {
      ...
      MaritalStatusList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetReligion()
    {
      ...
      ReligionList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetCountries()
    {
      ...
      countriesList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetSalaryOptions()
    {
      ...
      SalaryTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetHolidayTypes()
    {
      ...
      HolidayTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetContractTypes()
    {
      ...
      ContractTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetEndOfServiceReasonTypes()
    {
      ...
      EndOfServiceReasonTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetDeductionValueList()
    {
      ...
      deductionValues.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetClassIDList()
    {
      ...
      classIDList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetDeductionTypes()
    {
      ...
      deductionTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetOverTimeTypes()
    {
      ...
      overTimeTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetVacationTypes()
    {
      ...
      vacationTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetVacationDates()
    {
      ...
      vacationDateList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetEmployeeRequestTypes()
    {
      ...
      EmployeeRequestTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetProcessTypes()
    {
      ...
      processTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<List<SelectListItem>> GetMonthsTypes()
    {
      try
      {
        ...
        monthTypeList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
    ...
    public async Task<dynamic> GetDirectManager()
    {
      ...
      directManagerList.Insert(0, new SelectListItem { Value = "", Text = _localizer["lbl_Pleaseselect"] });
